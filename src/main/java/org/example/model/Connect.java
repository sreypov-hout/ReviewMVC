...
public class Connect {
    ...
    private static final String URL = "jdbc:postgresql://localhost:5432/postgres"; // Update host/port if necessary
    private static final String USER = "postgres"; // Change according to your PostgreSQL user
    private static final String PASSWORD = "pov123@num"; // Change according to your PostgreSQL password
